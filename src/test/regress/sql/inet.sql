...
SELECT i FROM (VALUES
  ...
  ('192.168.1.3/1'::inet),
  ('192.168.1.1/5'::inet),
  ('192.168.1.253/5'::inet),
  ('192.168.1.254/5'::inet),
  ('192.168.1.255/5'::inet),
  ('192.168.1.1/6'::inet),
  ('192.168.1.253/6'::inet),
  ('192.168.1.254/6'::inet),
  ('192.168.1.255/6'::inet),
  ('192.168.1.1/7'::inet),
  ('192.168.1.253/7'::inet),
  ('192.168.1.254/7'::inet),
  ('192.168.1.255/7'::inet),
  ('192.168.1.1/23'::inet),
  ('192.168.1.2/23'::inet),
  ('192.168.1.3/23'::inet),
  ('192.168.1.0/24'::inet),
